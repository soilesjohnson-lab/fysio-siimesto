      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-20 space-y-4">
          <h2 className="text-2xl md:text-4xl font-light text-[#1a1a1a] leading-tight">
            {/* Kehon voimaa, palautumista ja <br className="hidden md:block" /> tasapainoa. */}
            {data.approachTitleLine1}
            <br className="hidden md:block" />
            {data.approachTitleLine2}
          </h2>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-16 md:gap-12">
          ...
          {data?.servicesList?.map((item) => (
            <div key={item.title} className="flex flex-col items-center text-center space-y-6">
              <div className="w-px h-12 bg-gray-200"></div>
